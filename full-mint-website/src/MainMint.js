...
const roboPunksNFTAddress = "0x0f07f94FC996DBF446c0593E6da7059eD8984975";
    ...
    return(
        <Flex justify='center' align='center' height='100hv' paddingBottom='150px'>
            ...
            {isConnected ? (
                ...
                <Text margin='70px' fontSize='30px' letterSpacing='-5.5%' fontFamily='VT323' textShadow='0 3px #000000' color='#D6517D'>You must be connected to Mint.</Text>
            )}
            </Box>
        </Flex>
    );
